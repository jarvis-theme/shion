				            ...
				            <div class="well">
					            @if($order->jenisPembayaran==1)
									...
									@endif
										...
										<div class="controls">
										  	<input class="span6" type="text" name='nama' value='{{Input::old("nama"),array('style'=>'height: 30px;')}}' required>
										</div>
										</div>
										<div class="control-group">
										<label class="control-label" for="inputEmail"> No Rekening</label>
										<div class="controls">
										  	<input type="text" class="span6" name='noRekPengirim' value='{{Input::old("noRekPengirim"),array('style'=>'height: 30px;')}}' required>
										</div>
										</div>
										<div class="control-group">
